...
if weight_mode == "Custom":
    short_wgt = st.sidebar.slider("Short Weight", 0.0, 1.0, 0.33, 0.01)
    mid_wgt = st.sidebar.slider("Mid Weight", 0.0, 1.0, 0.33, 0.01)
    long_wgt = st.sidebar.slider("Long Weight", 0.0, 1.0, 0.34, 0.01)
    # Normalize weights
...
if 'dataset' in st.session_state:
    ...
    - **US Industry & Theme**: SMH, IGV, XAR, XBI, XME, XOP, PAVE, ARKK
    - **US Style**: MGK, MGV, IWM, SCHD, USMV, MTUM, QUAL
    - **Global Sector & Theme**: GDX, URA, IXN, IGF, BOTZ, SKYY, ICLN
